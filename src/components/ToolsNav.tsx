...
const ToolsNav: React.FC = () => {
  ...
  const [expandedCategories, setExpandedCategories] = useState<Set<string>>(new Set(['Home', 'Call', 'Engage', 'Prospect', 'Tools'])); // Default expanded
  ...
  return (
    <nav className="side-nav tools-nav">
      {/* Top border */}
